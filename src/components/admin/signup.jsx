...
const AdminSignup = () => {
  ...
  const handleSignup = async () => {
    ...
    try {
      const response = await fetch('https://ecommerce-backend-owgx.onrender.com/seller/signup', {
        method: 'POST',
        headers: {
  ...
  const handleVerificationMethodSelect = async (method) => {
    ...
    try {
      const response = await fetch('https://ecommerce-backend-owgx.onrender.com/seller/send-otp', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
  ...
  const handleVerifyOtp = async () => {
    ...
    try {
      const response = await fetch('https://ecommerce-backend-owgx.onrender.com/seller/verify-otp', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
  ...
  return (
    <>
      <Helmet>
        <title>Admin Signup | Mytalorzone</title>
      </Helmet>
      <Navbar />
